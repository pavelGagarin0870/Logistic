...
public sealed class PackOrderCommandHandler : IRequestHandler<PackOrderCommand, Unit>
{
    private readonly IEventStore _eventStore;

    public PackOrderCommandHandler(IEventStore eventStore)
    {
        _eventStore = eventStore;
    }

    public async Task<Unit> Handle(PackOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        aggregate.PackOrder(request.WarehouseId, request.Weight);
